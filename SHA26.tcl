...
#
# SHA256_v1.tcl: Tcl script for re-creating project 'SHA256_v1'
#
# Generated by Vivado on Sat Mar 26 21:29:56 KST 2022
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../SHA256/RTL/sha256.sv"]"\
 "[file normalize "$origin_dir/../SHA256/IP/component.xml"]"\
 "[file normalize "$origin_dir/../SHA256/CONSTRAINTS/test.xdc"]"\
 "[file normalize "$origin_dir/../SHA256/TB/tb_sha256.sv"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../SHA256"]"]"\
  ]
  foreach ipath $paths {
...
set tdate [clock format [clock seconds] -format %y%m%d%H%M]
set projName SHA256_
append projName $tdate
...
#set orig_proj_dir "[file normalize "$origin_dir/../../SystemVerilogSHA256/SHA256_v1"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../SHA256"]" $obj
...
set file "[file normalize "$origin_dir/../SHA256/CONSTRAINTS/test.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "CONSTRAINTS/test.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *CONSTRAINTS/test.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *CONSTRAINTS/test.xdc]" -objects $obj
...
set_property -name "top" -value "tb_sha256" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
connect_bd_intf_net -intf_net interface_axis_0_1 [get_bd_intf_pins sha256_0/interface_axis] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets interface_axis_0_1]

  # Create port connections
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins rst_design_1_100M/slowest_sync_clk] [get_bd_pins sha256_0/clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net clk_wiz_locked [get_bd_pins clk_wiz/locked] [get_bd_pins rst_design_1_100M/dcm_locked]
  connect_bd_net -net dummy_port_in_1 [get_bd_ports dummy_port_in] [get_bd_pins clk_wiz/reset] [get_bd_pins rst_design_1_100M/ext_reset_in] [get_bd_pins sha256_0/rst]
  ...
  connect_bd_net -net sha256_0_oid [get_bd_pins sha256_0/oid] [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net sha256_0_olen [get_bd_pins sha256_0/olen] [get_bd_pins vio_0/probe_in2]
  connect_bd_net -net sha256_0_osha [get_bd_pins sha256_0/osha] [get_bd_pins vio_0/probe_in3]
  connect_bd_net -net sha256_0_ovalid [get_bd_pins sha256_0/ovalid] [get_bd_pins vio_0/probe_in0]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../SHA256/RTL/design_1_wrapper.v" ]
} else {
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/SHA256_v1.srcs/utils_1/imports/impl_1" -objects $obj
